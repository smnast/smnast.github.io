    ...
    return (
        <>
            ...
            <div>
                ...
                <p>
                    The language is written in C++, without the use of extenral libraries like Yacc or Bison. It uses a polymorphism approach
            ...
            <div>
                <p>
                    ...
                    LemLib abstracts a lot of the complex features of creating autonomous programs, including <a href="https://en.wikipedia.org/wiki/Proportional%E2%80%93integral%E2%80%93derivative_controller">PID</a> control
                    and <a href="https://wiki.purduesigbots.com/software/odometry">odometry</a>.
                </p>
                <p>
                    The robot's path was found using a combination of online map programs, field measurements and trial-and-error. Other than driving, the robot needed to control other functions both autonomously and
                    with driver input. These included: "wings" (essentially snow plows, and were a vital part of that season's meta) and a catapult that doubled as a climbing mechanism.
                </p>
                <img src={Robot34300A} alt="34300A VEX robot" />
                <p>
                    There were many times during our last competition where the robot would turn around and try to escape the field.
                    It turned out that the upload was corrupted, and reuploading it fixed the problem.
                    This taught me the importance of testing the software before the matches began, even if everything <i>seems</i> like it should work.
                </p>
            </div>
            ...
            <div>
                <p>
                    ...
                    It was designed as an improvement of another VEX prototyping software, <a href="https://protobot.web.app/">Protobot</a>, with plans to add many new features
                    not found in its predecessor.
                </p>
                <p>
                    This was the first time that I worked on a project for more than a couple months. In total, I spent three months working on importing new parts and
                    adding core functionality. However, the project was rushed, creating many problems for me down the line.
                </p>
                <p>
                ...
                <p>
                    as well as automatic grouping of parts, built upon a system of "fasteners", "inserts" and "holes":
                </p>
                <p>
                    The main improvements of Robotica over Protobot include: significantly better performance (often 10x the framerate), faster load times, more parts,
                    more consistent automatic grouping, manual grouping, consistent saving/loading functionality and a <i>lot</i> more settings.
                </p>
                <img src={RoboticaGroup} alt="A C-channel automatically grouped with connected parts." />
                <p>
                    Several improvements could be made to the code design. For instance, separating the long <code>Control.cs</code> class would help keep the control
                    logic cleaner and maintainable. The part system could also be more abstracted to allow for easily adding new parts, without the need to edit
                    multiple files to introduce one part. Without these improvements, the project is difficult to maintain and continue.
                </p>
            </div>
            <a href="https://github.com/smnast/cp-tool"><h1>cp-tool</h1></a>
            <div>
                <p>
                    cp-tool is a simple Python script designed to create folders for competitive programming solution files. It supports creating files for an invidual problem,
                    or for an entire contest. Since many competitive programmers prefer to start their solution with a "template", cp-tool allows users to specify a template
                    and copies the desired code to their solution file.
                </p>
                <p>
                    To shorten the command to just <code>cpt</code> instead of <code>python cp-tool.py</code>, I wrote a separate shell script, with the added benefit of
                    being able to automatically <code>cd</code> into the new directory by sourcing the script (or <code>alias cpt='source cpt'</code>).
                </p>
                <p>
                    One improvement to this program would be a proper means of installing it (CMake or similar), rather than instructing prospective users to symlink the files to
                    their <code>bin</code> directory.
                </p>
            </div>
        </>
    )
